...
import com.appsimples.mutti.interusp_android.Adapter.FilterAdapter;
import com.appsimples.mutti.interusp_android.Adapter.JogoAdapter;
...
//        final ArrayList<String> filters = new ArrayList<String>(Arrays.asList(Constants.kFiltroJogoModalidade));
    ...
    public void setData() {
        ...
        if (!filters_lugar.contains("Todos"))

            filters_lugar.add(0, "Todos");
        filters_lugar.add(1, "A definir");
